...
NSString *const enKey = @"2D4A614E635266556A586E3272357538782F413F4428472B4B6250655367566B";
NSString *const ivValue = @"2D4A614E635266556A586E3272357538782F413F4428472B4B6250655367566B";


@implementation FWEncryptorAES

+ (NSData *)encrypt:(NSData *)data {
    return [FWEncryptorAES encrypt:data Key:enKey IV:ivValue];
}
+ (NSData *)decrypt:(NSData *)data {
    return [FWEncryptorAES decrypt:data Key:enKey IV:ivValue];
}
